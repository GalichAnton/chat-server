...
type ChatRepositoryMock struct {
	...
	funcGetChats          func(ctx context.Context) (ia1 []int64, err error)
...
func (mmGetChats *mChatRepositoryMockGetChats) Return(ia1 []int64, err error) *ChatRepositoryMock {
	if mmGetChats.mock.funcGetChats != nil {
		mmGetChats.mock.t.Fatalf("ChatRepositoryMock.GetChats mock is already set by Set")
	}
	...
	mmGetChats.defaultExpectation.results = &ChatRepositoryMockGetChatsResults{ia1, err}
	return mmGetChats.mock
}

// Set uses given function f to mock the ChatRepository.GetChats method
func (mmGetChats *mChatRepositoryMockGetChats) Set(f func(ctx context.Context) (ia1 []int64, err error)) *ChatRepositoryMock {
	if mmGetChats.defaultExpectation != nil {
...
func (e *ChatRepositoryMockGetChatsExpectation) Then(ia1 []int64, err error) *ChatRepositoryMock {
	e.results = &ChatRepositoryMockGetChatsResults{ia1, err}
	return e.mock
}

// GetChats implements repository.ChatRepository
func (mmGetChats *ChatRepositoryMock) GetChats(ctx context.Context) (ia1 []int64, err error) {
