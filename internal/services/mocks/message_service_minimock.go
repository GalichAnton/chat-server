...
//go:generate minimock -i github.com/GalichAnton/chat-server/internal/services.MessageService -o message_service_minimock.go -n MessageServiceMock -p mocks
...
// MessageServiceMock implements services.MessageService
...
// NewMessageServiceMock returns a mock for services.MessageService
...
func (mmSendMessage *mMessageServiceMockSendMessage) Expect(ctx context.Context, message *message.Info) *mMessageServiceMockSendMessage {
...
func (mmSendMessage *mMessageServiceMockSendMessage) Inspect(f func(ctx context.Context, message *message.Info)) *mMessageServiceMockSendMessage {
...
func (mmSendMessage *mMessageServiceMockSendMessage) Set(f func(ctx context.Context, message *message.Info) (err error)) *MessageServiceMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mMessageServiceMockSendMessage) When(ctx context.Context, message *message.Info) *MessageServiceMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("MessageServiceMock.SendMessage mock is already set by Set")
	}
...
// SendMessage implements services.MessageService
func (mmSendMessage *MessageServiceMock) SendMessage(ctx context.Context, message *message.Info) (err error) {
